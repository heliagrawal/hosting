                                        ...
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <select class="form-control" id="en_category_name" name="en_category_name">
                                                    ...
                                                    <optgroup label="{{ $item->en_Category_Name }}">
                                                       @foreach ($item->subcategory as $itemsubcategory)
                                                            <option value="{{ $itemsubcategory->id }}" {{ $itemsubcategory->id == $product->Category_Id ? 'selected' : '' }}>
                                                                {{ $itemsubcategory->en_SubCategory_Name }}
                                                            </option>
                                                        @endforeach
                                                    </optgroup>
                                                    @endforeach
