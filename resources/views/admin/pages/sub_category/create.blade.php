                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-vertical__item bg-style">
                                        <form enctype="multipart/form-data" method="POST" action="{{route('admin.sub_category.store')}}">
                                            @csrf
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" id="en_sub_category_name" name="en_sub_category_name" value="{{ old('en_sub_category_name') }}" placeholder="Name (English)">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label>{{ __('SubCategory Name '.langString('fr'))}}</label>
                                                <input type="text" id="fr_sub_category_name" name="fr_sub_category_name"  value="{{ old('fr_sub_category_name') }}" placeholder="Name (Arabic)">
                                            </div>
                                            <div class="input__group mb-25">
