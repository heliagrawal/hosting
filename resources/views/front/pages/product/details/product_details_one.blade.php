                            ...
                            <div class="product-slier-big-image">
                                <div class="product-priview-slide slider slider-for">
                                    <div class="single-slide">
                                        <a class="popup-image"
                                            href="{{ asset(ProductImage() . $products->Primary_Image) }}">
                                    ...
                                    @if ($products->Image4)
                                        <div class="single-slide">
                                            <a class="popup-image"
                                            href="{{ asset(ProductImage() . $products->Image4) }}">
                                    ...
                                    @if ($products->Image3)
                                        <div class="single-slide">
                                            <a class="popup-image"
                                            href="{{ asset(ProductImage() . $products->Image3) }}">
                                    ...
                                    @if ($products->Image5)
                                        <div class="single-slide">
                                            <a class="popup-image"
                                            href="{{ asset(ProductImage() . $products->Image5) }}">
                                    ...
                                    @if ($products->Image2)
                                        <div class="single-slide">
                                            <a class="popup-image"
                                            href="{{ asset(ProductImage() . $products->Image2) }}">
                        ...
                        <div class="product-single-right">
                            <div class="product-info">
                                ...
                                <div class="product-bottom-button d-flex">
                                    ...
                                    <a href="https://wa.me/{{ $allsettings['whats_app'] }}?text={{ urlencode(route('single.product', $products->en_Product_Slug) . ' ' . langConverter($products->en_Product_Name, $products->fr_Product_Name)) }}"
                                        title="{{ __('WhatsApp') }}" class="add-cart"><i class="fab fa-whatsapp"></i>
                                        {{ __('WhatsApp') }}</a>
                                </div>
                            </div>
