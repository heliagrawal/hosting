                        ...
                        <div class="product-info">
                            ...
                            <div class="prdouct-btn-wrapper d-flex align-items-center">
                                ...
                                {{-- <a href="javascript:void(0)" title="{{ __('Add To Cart') }}"
                                    ...
                                    <a href="https://wa.me/{{ $allsettings['whats_app'] }}?text={{urlencode(route('single.product', $products->en_Product_Slug)." ".langConverter($products->en_Product_Name, $products->fr_Product_Name))}}" title="{{ __('WhatsApp') }}"
                                        class="add-cart"><i
                                        class="fab fa-whatsapp"></i>  {{ __('WhatsApp') }}</a>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-grid-product-v2">
                        ...
                        <div class="product-info text-center">
                            ...
                            <a href="https://wa.me/{{ $allsettings['whats_app'] }}?text={{urlencode(route('single.product', $product->en_Product_Slug)." ".langConverter($product->en_Product_Name, $product->fr_Product_Name))}}" title="{{ __('WhatsApp') }}"
                                class="add-cart"><i
                                class="fab fa-whatsapp"></i>  {{ __('WhatsApp') }}</a>
