...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'is_admin', 'en.locale'], 'as' => 'admin.'], function () {
    ...
    Route::group(['prefix' => 'sub-category'], function () {
        Route::get('', [SubCategoryController::class, 'sub_category'])->name('sub_category')->middleware(['permission:sub_category-list|sub_category-create|sub_category-edit|sub_category-delete']);
        Route::get('/create', [SubCategoryController::class, 'sub_categoryCreate'])->name('sub_category.create')->middleware(['permission:sub_category-create']);
        Route::post('/create', [SubCategoryController::class, 'sub_categoryStore'])->name('sub_category.store')->middleware(['permission:sub_category-create', 'isDemo']);
        Route::get('/edit/{id}', [SubCategoryController::class, 'sub_categoryEdit'])->name('sub_category.edit')->middleware(['permission:sub_category-edit']);
        Route::post('/update', [SubCategoryController::class, 'sub_categoryUpdate'])->name('sub_category.update')->middleware(['permission:sub_category-edit', 'isDemo']);
        Route::get('/active/{id}', [SubCategoryController::class, 'sub_categoryActive'])->name('sub_category.active')->middleware(['permission:sub_category-edit', 'isDemo']);
        Route::get('/inactive/{d}', [SubCategoryController::class, 'sub_categoryInactive'])->name('sub_category.inactive')->middleware(['permission:sub_category-edit', 'isDemo']);
        Route::get('/delete/{id}', [SubCategoryController::class, 'sub_categoryDelete'])->name('sub_category.delete')->middleware(['permission:sub_category-delete', 'isDemo']);
    });
